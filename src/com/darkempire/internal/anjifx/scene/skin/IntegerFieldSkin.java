 ...
 */
public class IntegerFieldSkin extends SkinBase<IntegerField> {
    private IntegerField control;
    ...
    public IntegerField getControl() {
        return control;
    }
    ...
    private void createListeners() {
        ...
        textField.focusedProperty().addListener((observableValue, wasFocused, isFocused) -> {
            if (isFocused) {
                control.getStyleClass().add("integer-field-focused");
            } else {
                control.getStyleClass().remove("integer-field-focused");
            }
        });
