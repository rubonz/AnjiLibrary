 ...
 */
public class AnjiColorProperty extends AbstractAnjiProperty<Color> implements IAnjiValue<Color> {
    private Color value;

    public AnjiColorProperty(String name, Color value) {
        super(name);
        this.value = value;
    }

    public AnjiColorProperty(Object bean, String name, Color value) {
        super(bean, name);
        this.value = value;
    }
